...
import SearchResultsContainer from './modules/search-results';
import ViewJobsContainer from './modules/view-jobs';
          ...
          <Stack.Navigator
            ...
            {isLoggedIn ? (
              <Fragment>
                ...
                />
                <Stack.Screen
                  name={RouteNames.viewJobs}
                  component={ViewJobsContainer}
                />
              </Fragment>
            ) : (
              <Fragment>
...
export default withAuth(withGeolocation(withNotification(Navigator)));
